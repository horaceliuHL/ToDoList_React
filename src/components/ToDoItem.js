        ...
        return (
            <div id={'todo-list-item-' + listItem.id} className='list-item-card1'>
                ...
                <div className='item-col list-controls-col'>
                    <KeyboardArrowUp className='list-item-control todo-button upArrow' />
                    <KeyboardArrowDown className='list-item-control todo-button downArrow' />
                    <Close className='list-item-control todo-button deleteItem' />
